                ...
                children: <Widget>[
                  Container(
                    ...
                    decoration: BoxDecoration(
                      border: Border.all(width: 1.0, color: ColorResources.colorGrayLite),
                    ...
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: const <Widget>[
                        Icon(Icons.group, color:  ColorResources.colorPrimary, size: 30.0),
                        SizedBox(height: 5.0),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: const <Widget>[
                        Icon(Icons.shopping_basket, color:  ColorResources.colorPrimary, size: 30.0),
                        SizedBox(height: 5.0),
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: const <Widget>[
                        Icon(Icons.person, color:  ColorResources.colorPrimary, size: 30.0),
                        SizedBox(height: 5.0),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: const <Widget>[
                        Icon(Icons.history, color:  ColorResources.colorPrimary, size: 30.0),
                        SizedBox(height: 5.0),
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: const <Widget>[
                        Icon(Icons.flag, color:  ColorResources.colorPrimary, size: 30.0),
                        SizedBox(height: 5.0),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: const <Widget>[
                        Icon(Icons.save_alt, color:  ColorResources.colorPrimary, size: 30.0),
                        SizedBox(height: 5.0),
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: const <Widget>[
                        Icon(FontAwesomeIcons.shoppingBag, color:  ColorResources.colorPrimary, size: 25.0),
                        SizedBox(height: 5.0),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: const <Widget>[
                        Icon(Icons.event, color:  ColorResources.colorPrimary, size: 30.0),
                        SizedBox(height: 5.0),
              ...
              child: Row(
                ...
                children: <Widget>[
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceAround,
                    children: const <Widget>[
                      Icon(Icons.help, size: 40.0, color:   ColorResources.dividerColor),
                      SizedBox(width: 10.0),
              ...
              child: Row(
                ...
                children: <Widget>[
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceAround,
                    children: const <Widget>[
                      Icon(Icons.settings, size: 40.0, color:   ColorResources.dividerColor),
                      SizedBox(width: 10.0),
              ...
              child: Row(
                ...
                children: <Widget>[
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceAround,
                    children: const <Widget>[
                      Icon(Icons.exit_to_app, size: 40.0, color:   ColorResources.dividerColor),
                      SizedBox(width: 10.0),
