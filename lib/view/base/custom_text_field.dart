  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: TextField(
        ...
        style: Theme.of(context).textTheme.headline2!.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.FONT_SIZE_LARGE),
        textInputAction: widget.inputAction,
        keyboardType: widget.inputType,
        cursorColor: ColorResources.colorPrimary,
        ...
        decoration: InputDecoration(
          ...
          fillColor: widget.fillColor != null ? widget.fillColor : Theme.of(context).backgroundColor,
          hintStyle: Theme.of(context).textTheme.headline2!.copyWith(fontSize: Dimensions.FONT_SIZE_DEFAULT, color: ColorResources.COLOR_GREY_CHATEAU),
          filled: true,
