  ...
  Future<void> getPosts() async {
    ...
    await Future.delayed(Duration(seconds: 2), () {
      List<PostModel> postList = [
        ...
        PostModel(type: PostType.textImage,
            images: [
        ...
        PostModel(type: PostType.textImage,
            ...
            comments: '6',
            shares: '4'),
        PostModel(type: PostType.Images,
            images: [
              'https://s3-eu-west-1.amazonaws.com/wuzzuf/files/company_logo/The-Post-Office-Egypt-39194-1548624988.jpg',
              'https://s3-eu-west-1.amazonaws.com/wuzzuf/files/company_logo/The-Post-Office-Egypt-39194-1548624988.jpg'
            ],
   ...
   List<GroupModel>   groupList = [
    ...
    List<GroupModel>  shortcutsList = [
     ...
     List<SponsorModel> sponsorList = [
      ...
      homeModel = HomeModel(groupList :groupList, postList:postList, sponsorList:sponsorList, storyList:storyList, contactList:contactList, shortcutsList: shortcutsList);

    });
    emit(RequestSuccessState(homeModel));

  }

  getNotifications(){
    List<UserNotification> notificationList = [
      UserNotification(imageUrl: 'assets/goalcast.png', content: 'Goalcast posted a new video', time: '3 hours ago'),
      UserNotification(imageUrl: 'assets/playstation.jpg', content: 'Playstation posted a new video', time: '8 hours ago'),
      UserNotification(imageUrl: 'assets/xbox.jpeg', content: 'Xbox posted a new video', time: '9 hours ago'),
      UserNotification(imageUrl: 'assets/reddit.png', content: 'Reddit posted a new video', time: '22 hours ago'),
      UserNotification(imageUrl: 'assets/linkedIn.jpg', content: 'Linkedin posted a new video', time: '1 day ago'),
      UserNotification(imageUrl: 'assets/goalcast.png', content: 'Goalcast posted a new video', time: '4 days ago'),
      UserNotification(imageUrl: 'assets/reddit.png', content: 'Reddit posted a new video', time: '6 days ago'),
      UserNotification(imageUrl: 'assets/xbox.jpeg', content: 'Xbox posted a new video', time: '1 week ago'),
      UserNotification(imageUrl: 'assets/linkedIn.jpg', content: 'Linkedin posted a new video', time: '3 weeks ago'),
      UserNotification(imageUrl: 'assets/playstation.jpg', content: 'Playstation posted a new video', time: '1 month ago')
    ];

    emit(NotificationSuccessState(notificationList));
  }
}
